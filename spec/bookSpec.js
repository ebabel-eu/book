...
describe( "Book function", function () {
    ...
    it( "returns at least one error when it isn't supplied with any parameter.", function () {
        expect( namespace.book().errors.length ).toBeGreaterThan( 0 );
    } );

    it( "returns at least one error when it isn't supplied with at least one valid parameter.", function () {
        expect( namespace.book( {} ).errors.length ).toBeGreaterThan( 0 );
    } );

    it( "returns at least one error when it is supplied with an unexpected parameter but no valid parameter.", function () {
...
describe( "Data query", function () {
    ...
    it( "returns at least one book written in British English.", function () {
